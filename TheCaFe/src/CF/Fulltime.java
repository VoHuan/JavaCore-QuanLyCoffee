...
public class Fulltime extends Employee {
	static Employee FT[] = new Employee[50];
	static int lenFT=0;
	...
	public Fulltime(String id, String name, int year, String address, String phone, String mail) {
		super(id, name, year, address, phone, mail);
	}
	...
	public String toString() {
		return id+","+name+","+this.getAge()+","+address+","+phone+","+mail;
	}
	public String toString2() {
		return String.format("%-7s %-25s %-7s %-40s %-15s %-30s\n",id,name,this.getAge(),address,phone,mail);
	}
	@Override
	public void Display() {
	...
	public void ReadList() {
		try {
			FileReader fr = new FileReader("EmployeeFullTime.txt");
			...
			while(true) {
				...
				String phone = txt[4];
				String mail = txt[5];
				FT[lenFT] = new Fulltime(id,name,year,address,phone,mail);				
				lenFT++;
			}
